####RAW DATA FILTERING AND DESCRIPTIVES
...
raw_data <- collected_data |>
  ...
  mutate(
    ...
    Anxiety_Debilitation = as.character(Anxiety_Debilitation),
...
raw_data <- raw_data |>
  mutate(
    ##Playstyle categories: Friends, Acquaintances, Strangers. The rest were manually filled by participants.
    Playstyle = case_when(
    ...
    ##Work categories: School, University, Unemployed, Employed
    Work = case_when(
    ...
    ##Degree categories: High_School_Diploma, B.A, M.A, PHD, None
    ##Degree had problematic coding of non-breaking spaces. next line replaces them with regular spaces
...
paste("The amount of participants in experiment after 'other' filtering:", nrow(simple_raw_data))

#saving raw data and simple raw data
