...
- Another result concluded from the regression is that when not gaming at all (hours per week = 0), singleplayer gamers report about 1.249 points higher anxiety than multiplayer gamers (β2 = 1.249, _p_ = 4.9 * 10^-5).  
