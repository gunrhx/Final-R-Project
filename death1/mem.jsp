...
{{"rname"},{"options","James","Brian","Francois","Pierre","I do not remember"}}, 
{{"rnational"},{"options","American","British","French","German"}}, 
{{"rlive"},{"options","Alive","Dead","I do not remember"}}, 
};
...
String[][][] explicit =
{
{{"explicit"}, {"choices","ratings"},{"nelem","6"},{"musthave","0"},{"group","0"},{"gminmax","6.6"},{"gplace","0"},{"gorder","0"},{"gsequence","random"}, {"prefix","Based on the information we provided about him, "}},
{{"jamesname"},{"choices","rname"},{"stem","what is the name of this person?<br/><img src='/implicit/user/ybalab/daniel/death1/images/james.jpg'/>"}},
{{"brianname"},{"choices","rname"},{"stem","what is the name of this person?<br/><img src='/implicit/user/ybalab/daniel/death1/images/brian.jpg'/>"}},
{{"jamesnational"},{"choices","rnational"},{"stem","what do you think the nationality of this man is?<br/><img src='/implicit/user/ybalab/daniel/death1/images/james.jpg'/>"}},
{{"briannational"},{"choices","rnational"},{"stem","what do you think the nationality of this man is?<br/><img src='/implicit/user/ybalab/daniel/death1/images/brian.jpg'/>"}},
{{"jameslive"},{"choices","rlive"},{"stem","is this person alive or dead?<br/><img src='/implicit/user/ybalab/daniel/death1/images/james.jpg'/>"}},
{{"brianlive"},{"choices","rlive"},{"stem","is this person alive or dead?<br/><img src='/implicit/user/ybalab/daniel/death1/images/brian.jpg'/>"}},
};
